      ...
      {items.map((item) => {
        ...
        return (
          <NavLink
            ...
            className={({ isActive }) =>
              clsx(
                "group flex min-h-14 flex-col items-center justify-center gap-1 rounded-lg px-1 text-[10px] font-black transition duration-200 lg:min-h-0 lg:flex-row lg:justify-start lg:gap-3 lg:px-4 lg:py-3 lg:text-sm",
                isActive
                  ? "bg-gradient-to-br from-sky-100 to-violet-100 text-sky-700 shadow-sm dark:from-sky-500/10 dark:to-violet-500/10 dark:text-primary"
